...
| SPIKE-31 | **Phase 1b shipped** | **Toolbar & layer tab UX** — labeled toolbar + ALP trim; tab chrome + Layer button pending — [spike doc](sweethome3d-spike-31-toolbar-and-layer-tab-ux.md) |
