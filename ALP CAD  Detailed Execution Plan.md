...
| SPIKE-32 | Spec locked | **Area fill texture inspector** — library/category selectors, filtered Fill texture popup, landscape `.sh3t` pack — [spike doc](sweethome3d-spike-32-area-fill-texture-inspector.md) |
