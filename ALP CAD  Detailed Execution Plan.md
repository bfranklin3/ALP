...
| SPIKE-31 | **Phase 1c shipped** | **Toolbar & layer tab UX** — labeled toolbar, ALP trim, tab chrome + Layer button — [spike doc](sweethome3d-spike-31-toolbar-and-layer-tab-ux.md) |
