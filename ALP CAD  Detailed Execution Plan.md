...
| SPIKE-31 | **Phase 1a in progress** | **Toolbar & layer tab UX** — labeled toolbar (Option B), tab chrome, + Layer button — [spike doc](sweethome3d-spike-31-toolbar-and-layer-tab-ux.md) |
