...
function LandscapeShellPanel(parentWidget, appWin) {
    ...
    var file = new QFile(LandscapeShellPanel.includeBasePath + "/landscape-shell-prototype-v15.ui");
...
function registerLandscapeWallGuiAction() {
    ...
    var scriptFile = LandscapeShellPanel.includeBasePath + "/LandscapeShellWallAction-v15.js";
