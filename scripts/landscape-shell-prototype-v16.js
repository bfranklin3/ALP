...
function LandscapeShellPanel(parentWidget, appWin) {
    ...
    var file = new QFile(LandscapeShellPanel.includeBasePath + "/landscape-shell-prototype-v16.ui");
...
function registerLandscapeWallGuiAction() {
    ...
    var scriptFile = LandscapeShellPanel.includeBasePath + "/LandscapeShellWallAction-v16.js";
